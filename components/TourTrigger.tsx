...
const steps: Step[] = [
  ...
  },
  {
    ...
    text: 'Four numbers a manager scans in 10 seconds: team focus, active projects, new-hire ramp, AI-touched output. Each card drills into the underlying activity.',
    label: 'Manager View',
    dir: 'bottom',
  },
  {
    ...
    text: 'The core value prop. Pieces surfaces patterns worth a conversation. A stalled project. Someone stretched thin. A ramp going well. Every signal is a question, never a verdict.',
    label: 'Signals',
    dir: 'top',
  },
  {
