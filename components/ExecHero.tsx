  ...
  return (
    <div className="rounded-card bg-ink-900 border border-ink-700 p-10 relative overflow-hidden">
      ...
      <div className="relative">
        <CollapsibleSummary
          expandLabel="Expand executive brief"
          collapseLabel="Collapse executive brief"
          toggleClassName="text-surface-400 hover:text-surface-200"
          preview={
            <>
              ...
              <h2 className="font-display font-bold text-[34px] text-white leading-tight tracking-tight max-w-[820px]">
                {headline}
              </h2>
            </>
          }
