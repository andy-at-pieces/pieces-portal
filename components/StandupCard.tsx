...
export default function StandupCard() {
  return (
    <div className="rounded-card border border-surface-200 bg-white p-7 relative overflow-hidden">
      {/* Lime accent rail (only place lime lives in light theme) */}
      ...
      <div className="text-sm text-ink-500 leading-relaxed max-w-[780px] space-y-3">
        <p>
          ...
          <strong className="text-ink font-semibold">Enterprise Reporting</strong> project. Most of that
          was the stakeholder call with Tsavo, Ali, Mack, Mark, Brian, and Gavin, followed by 52 minutes
          revising the scope doc. You closed Ali&apos;s feedback on benchmarking and opened a thread with
          Musa on the pipeline migration.
        </p>
        <p>
